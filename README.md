...
directory, and will in a directory called **Charlatano 1.0.4**.

From within the **Charlatano 1.0.4** directory, you can start the cheat by running
the _"Start Charlatano 1.0.4"_ script.
