...
object ClientOffsets {
	...
	val bDormant by clientDLL(0xC, subtract = false)(
	...
	val dwForceJump by clientDLL(2)(
			0x89, 0x0D, 0[4], 0x8B, 0x0D, 0[4], 0x8B,
			0xF2, 0x8B, 0xC1, 0x83, 0xCE, 0x08
	)
	
	var dwLocalPlayer by clientDLL(1, 0x10)(
			0xA3, 0[4], 0xC7, 0x05, 0[8], 0xE8, 0[4], 0x59, 0xC3, 0x6A, 0
	)
