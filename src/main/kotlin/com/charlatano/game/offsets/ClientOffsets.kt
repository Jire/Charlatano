...
object ClientOffsets {
	...
	val dwLocalPlayer by clientDLL(0x1, 0x2C)(0xA3, 0[4], 0xC7, 0x05, 0[8], 0xE8, 0[4], 0x59, 0xC3, 0x6A, 0)
	...
	fun localPlayer() = if (CLASSIC_OFFENSIVE) 0x00AA581CL else dwLocalPlayer
