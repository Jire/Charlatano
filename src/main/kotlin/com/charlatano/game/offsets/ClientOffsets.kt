...
object ClientOffsets {
	...
	val decalref = 543296166L // need to figure out how to get this later
	val dwFirstClass by lazy(LazyThreadSafetyMode.NONE) { csgoEXE.uint(decalref + 0x3B) }
	...
	val dwSensitivity by clientDLL(2, 44)(0x81, 0xF9, 0[4], 0x75, 0x1D, 0xF3, 0x0F, 0x10, 0x05, 0[4],
			0xF3, 0x0F, 0x11, 0x44, 0x24, 0, 0x8B, 0x44, 0x24, 0x0C, 0x35, 0[4], 0x89, 0x44, 0x24, 0x0C)
	val dwSensitivityPtr by clientDLL(2)(0x81, 0xF9, 0[4], 0x75, 0x1D, 0xF3, 0x0F, 0x10, 0x05, 0[4], 0xF3, 0x0F, 0x11,
			0x44, 0x24, 0, 0x8B, 0x44, 0x24, 0x0C, 0x35, 0[4], 0x89, 0x44, 0x24, 0x0C)
