...
object ClientOffsets {
	...
	val bDormant = 0xEDL/*by clientDLL(0xC, subtract = false)(
	...
	var dwLocalPlayer = 0xCB3694L/*by clientDLL(1, 0x10)(
			0xA3, 0[4], 0xC7, 0x05, 0[8], 0xE8, 0[4], 0x59, 0xC3, 0x6A, 0
	)*/
	val dwGlowObject by clientDLL(1, 4)(0xA1, 0[4], 0xA8, 0x01, 0x75, 0x4B)
	val dwEntityList = 0x4CC36D4L//by clientDLL(1)(0xBB, 0[4], 0x83, 0xFF, 0x01, 0x0F, 0x8C, 0[4], 0x3B, 0xF8)
	...
	var dwPlayerResource by clientDLL(2)(
			0x8B, 0x3D, 0[4], 0x85, 0xFF, 0x0F, 0x84, 0[4], 0x81, 0xC7
	)
	
	var dwRadarBase by clientDLL(1)(
