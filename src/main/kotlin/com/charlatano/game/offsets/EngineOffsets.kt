...
object EngineOffsets {
	...
	val dwClientState by engineDLL(1)(0xA1, 0[4], 0x33, 0xD2, 0x6A, 0, 0x6A, 0, 0x33, 0xC9, 0x89, 0xB0, 0xB0)
	...
	val studioModel by engineDLL(0x2)(0x8B, 0xB6, 0[4], 0x85, 0xF6, 0x74, 0x05,
			0x83, 0x3E, 0x00, 0x75, 0x02, 0x33, 0xF6, 0xF3, 0x0F, 0x10, 0x44, 0x24)
